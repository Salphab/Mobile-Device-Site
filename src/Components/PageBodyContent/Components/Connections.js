...
function Connections() {
    ...
    let DeviceNetwork1 = data1 && data1[0]?.detailSpec[9];
    let DeviceNetwork2 = data2 && data2[0]?.detailSpec[9];
    let DeviceNetwork3 = data3 && data3[0]?.detailSpec[9];
    useEffect(()=>{
        if(data1){
    ...
    return (
        <section className='relative bg-slate-50 rounded mt-[1%] block w-[100%] max-w-[100%] h-[fit-content]'>
            <div className='relative w-[100%] max-w-[100%] h-[12%]'>
                <h2 className='relative w-[100%] max-w-[100%] pl-[2%] py-[2%] font-[ariel] text-lg font-bold h-[100%]'>Connectivity</h2>
            </div>
            <table className='relative flex w-[100%] max-w-[100%] h-[88%]'>
                <tbody className='relative w-[100%] max-w-[100%]'>
                   <tr class='relative flex w-[100%] rounded bg-gray-200 max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>Wifi</td>
                   ...
                   <tr class='relative flex w-[100%] max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>Bluetooth</td>
                   ...
                   <tr class='relative flex w-[100%] bg-gray-200 max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>GPS</td>
                   ...
                   <tr class='relative flex w-[100%] max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>NFC</td>
                   ...
                   <tr class='relative flex w-[100%] bg-gray-200 max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>Radio</td>
                   ...
                   <tr class='relative flex w-[100%] max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>USB</td>
                        <td class='relative flex font-[monserrat] py-[1%] text-sm text-justify pl-[2%] pr-[3%] w-[100%] max-w-[28.33%]'>{DeviceNetwork1?.specifications[5]?.value || <span class='relative m-auto'>-</span>}</td>
                        <td class='relative flex font-[monserrat] py-[1%] text-sm w-[100%] pl-[2%] pr-[3%] w-[100%] max-w-[28.33%]'>{DeviceNetwork2?.specifications[5]?.value || <span class='relative m-auto'>-</span>}</td>
                        <td class='relative flex font-[monserrat] py-[1%] text-sm pl-[2%] pr-[3%] w-[100%] max-w-[28.33%]'>{DeviceNetwork3?.specifications[5]?.value || <span class='relative m-auto'>-</span>}</td>
                   </tr>
                </tbody>
            </table>
        </section>
