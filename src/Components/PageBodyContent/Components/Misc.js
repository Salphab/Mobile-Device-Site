...
function Skin() {
    ...
    let DeviceNetwork1 = data1 && data1[0]?.detailSpec[12];
    let DeviceNetwork2 = data2 && data2[0]?.detailSpec[12];
    let DeviceNetwork3 = data3 && data3[0]?.detailSpec[12];
    useEffect(()=>{
        if(data1){
    ...
    return (
        <section className='relative mb-[2%] block w-[100%] max-w-[100%] h-[fit-content]'>
            <div className='relative w-[100%] max-w-[100%] h-[12%]'>
                <h2 className='relative w-[100%] max-w-[100%] pl-[2%] py-[2%] font-[ariel] text-xl font-bold h-[100%]'>Skin</h2>
            </div>
            <table className='relative flex w-[100%] max-w-[100%] h-[88%]'>
                <tbody className='relative w-[100%] max-w-[100%]'>
                   <tr class='relative flex w-[100%] rounded bg-gray-200 max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>Color</td>
                   ...
                   <tr class='relative flex w-[100%] rounded max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>Models</td>
                   ...
                   <tr class='relative flex w-[100%] rounded bg-gray-200 max-w-[100%]'>
                        <td class='relative font-[monserrat] py-[1%] italic pl-[2%] w-[100%] max-w-[15%]'>SAR</td>
