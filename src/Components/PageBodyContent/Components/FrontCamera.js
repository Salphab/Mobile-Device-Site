...
function FrontCamera() {
    ...
    let DeviceNetwork1 = data1 && data1[0]?.detailSpec[7];
    let DeviceNetwork2 = data2 && data2[0]?.detailSpec[7];
    let DeviceNetwork3 = data3 && data3[0]?.detailSpec[7];
    useEffect(()=>{
        if(data1){
    ...
    return (
        <section className='relative bg-slate-50 rounded mt-[1%] block w-[100%] max-w-[100%] h-[fit-content]'>
            <div className='relative w-[100%] max-w-[100%] h-[12%]'>
                <h2 className='relative w-[100%] max-w-[100%] pl-[2%] py-[2%] font-[ariel] text-lg font-bold h-[100%]'>Front Camera</h2>
            </div>
