        ...
        return(
            <ComparisonContext.Consumer>
                ...
                <div class='relative mt-[4%] block w-[100%] max-w-[95%] m-auto h-[70%] border-t-[1px] border-gray-400'>
                    <h2 className='relative w-[100%] max-w-[100%] text-center mt-[3%] text-md font-[monserrat] text-gray-700 font-semibold'>{data2.name}</h2>
                    <img class='relative m-auto mt-[7%] hover:cursor-pointer' src={data2.img} alt={data2.name}/>
                </div>
