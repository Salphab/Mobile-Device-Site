...
function DeviceAnnounce(){
    const Context = useContext(context);
    const info = Context.detailSpec[1].specifications;

    return(
        <div class='relative block bg-slate-50 mb-[1%] w-[100%] max-w-[100%] h-[fit-content]'>
            <header class='relative w-[100%] max-w-[100%] pl-[2%] text-gray-700 text-xl text-center font-semibold font-[montserrat] py-[.1%] bg-gray-300'>{Context.detailSpec[1].category}</header>
