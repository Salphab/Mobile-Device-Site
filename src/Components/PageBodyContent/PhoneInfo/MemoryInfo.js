...
function MemoryInfo(){
    ...
    const info = Context.detailSpec[5].specifications;

    return(
        <div class='relative block mb-[1%] w-[100%] max-w-[100%] h-[fit-content]'>
            <header class='relative w-[100%] max-w-[100%] pl-[2%] text-gray-700 text-xl text-center font-semibold font-[montserrat] py-[.1%] bg-gray-300'>{Context.detailSpec[5].category}</header>
